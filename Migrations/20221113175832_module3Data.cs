...
namespace EfCoreMovies.Migrations
{
    ...
    public partial class module3Data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "CinemaOffers",
                columns: new[] { "Id", "Begin", "CinemaId", "DiscountPercentage", "End", "Name" },
                values: new object[,]
                {
                    { 1, new DateTime(2022, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 10m, new DateTime(2022, 4, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), null },
                    { 2, new DateTime(2022, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, 15m, new DateTime(2022, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), null }
                });
